...
- The blue stop opens its own project page, based on [the editable Figma template](https://www.figma.com/design/lZzu3s65EB0ncM6igvjU4d/Leo-CTA-Portfolio?node-id=62-3). Two 800 × 450 (16:9) enclosure renders are stacked together, followed by an interactive 3D enclosure. The route and footer extend to accommodate the media. Copy areas stay blank, and both Back to map links remain. View project and Source code buttons are omitted.
